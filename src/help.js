...
◪ *INFO*
  ❏ Prefixo: 「  ${prefix}  」
  ❏ Criador: MARIANO DOMINA 
◪ *SOBRE* TYO DO CAFE 
  │
  ├─ ❏ ${prefix}instagram : *OFF NO MOMENTO*

  ├─ ❏ ${prefix}blocklist
  ├─ ❏ ${prefix}grupo whatsapp : *OFF NO MOMENTO*
  ├─ ❏ ${prefix} numero whatsapp wa.me//+5511970115273
  └─ ❏ ${prefix}telegram : *OFF NO MOMENTO*
